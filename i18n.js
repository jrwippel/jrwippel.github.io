const translations = {
  en: {
    ...
    vehicleShot1:
      "Centralized dashboard with real-time visibility of vehicle transfer orders and their current status",
    vehicleShot2:
      "Vehicle and transfer management interface, enabling efficient control of fleet operations and assignments",
    vehicleShot3:
      "Detailed order view with complete information for tracking, planning, and operational decision-making",
  ...
  pt: {
    ...
    vehicleShot1:
      "Dashboard centralizado com visibilidade em tempo real das ordens de transferência de veículos e seu status atual",
    vehicleShot2:
      "Interface de gerenciamento de veículos e transferências, permitindo controle eficiente das operações da frota",
    vehicleShot3:
      "Detalhes completos do pedido para rastreamento, planejamento e tomada de decisões operacionais",
